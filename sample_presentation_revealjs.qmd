...
The overall results look good - net Sharpe Ratio and net PnL is negative for two quarter, Q3 2023 and Q1 2025. Average number of transaction is more than 2 trades per day. Final statistics sum up to **24,11**.
...
Steady, growing trend indicates profitable strategy. Little gap between gross and net PnL means low total transaction costs.
...
Strategy started off strong - quick increase of both gross and net PnL. However, higher volatility in the second part of the quarter resulted in final negative cumulative net PnL.
...
Strong and steady start, resulting in almost $20,000 net PnL at peak. Followed by rapid decline and steady end of a quarter. 
...
```
Strong, downward trend with high volatility in second half of the quarter. Negative values indicates losing startegy.
...
Highly volatile results - slow start with strong losses, turning into positive final cumulative net PnL. Slow growth of the gap between gross and net PnL.

## Summary and conclusions

Overall results of the startegies are good. Both startegies ended up with positive statistic values for most of the quarters - **28 and 24 for group 1 and 2** respectively. The implementation of stop-loss condition had the biggest impact on the results, making the strategies profitable. 