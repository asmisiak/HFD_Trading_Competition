...
As a result of the trial and error process, we have ended with volatility breakout model for **SP** with signal and slow EMA of 30 and 240 respectively. The window lenght used in volatilities calculation was set to 120, while the multiplier for lower and upper threshold was set to 1. The stop-loss assumption was set as maximum of $500 loss per day.
...
More volatility can be observed - also 
